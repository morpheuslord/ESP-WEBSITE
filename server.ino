        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (header.indexOf(base64Encoding)>=0)
            {
              ...
              client.println("<div id='loading'><div id='spinner'></div></div><div id='header' class='animated slideInDown' style='animation-delay:1s;'><div id='title'></div><br><div id='links'><a href='#about'>about </a><a href='#skills'>skills</a><a href='#work' style='margin:0px 0px;'>works</a><a href='#kasper'>KasperMap</a><a href='#contact'>contact</a></div></div></div></div>");
              ...
              client.println(" <div id='kasper'><h1>KasperMap.</h1><div><div><iframe width='900' height='640' src='https://cybermap.kaspersky.com/en/widget/dynamic/dark' frameborder='0'></iframe></div>");
